...
import { useRiskContext } from '../context/RiskContext'; // Context 사용
import { useFocusTrap } from '../hooks/useFocusTrap'; // Correct named hook import
...
const PaywallBarrier: React.FC = () => {
  ...
  useFocusTrap(modalRef); // Correctly pass RefObject
  ...
  return (
    ...
    >
      <div ref={modalRef} className="relative w-full max-w-4xl scale-100 opacity-100">
        {/* 🚨 최상단 경고 헤더 (Red Zone) */}
