 ...
 */
const calculateThreatIndex = (data: E2EFormData): { riskLevel: "Low" | "Medium" | "High"; threatIndex: number } => {
...
const PaywallGateway = ({ threatIndex, isRedZone, isPaywallVisible = true }: { threatIndex: number; isRedZone: boolean; isPaywallVisible?: boolean }) => {
